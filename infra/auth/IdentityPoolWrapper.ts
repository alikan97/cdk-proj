...
import { IDENTITY_POOL_NAME } from "../../constants/constants";
...
export class IdentityPoolWrapper {
    ...
    private initializeIdentityPool() {
        this.identityPool = new CfnIdentityPool(this.scope, IDENTITY_POOL_NAME, {
    ...
    private initializeRoles() {
        this.authenticatedRole = new Role(this.scope, 'CognitoDefaultAuthRole', {
        ...
        this.unAuthenticatedRole = new Role(this.scope, 'CognitoDefaultUnAuthRole', {
            assumedBy: new FederatedPrincipal('cognito-identity.amazonaws.com', {
                StringEquals: {
                    'cognito-identity.amazonaws.com:aud': this.identityPool.ref
                },
